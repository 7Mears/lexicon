...
Plugin URI: http://www.endboss.ca
Description: Adds a widget that shows the most recent posts from a single category.
Author: End Boss
Version: 1.0
Author URI: http://endboss.ca
*/
...
class CategoryPosts extends WP_Widget {
	function CategoryPosts() {
		$widget_ops = array('classname' => 'eb-post-widget', 'description' => __('List single category posts'));
		$this->WP_Widget('category-posts', __('Display Posts'), $widget_ops);
	}
		...
		while ( $cat_posts->have_posts() )
		{
			...
			<div class="eb-post-item">
				...
				<figure>
					...
					?>
				<a href="<?php the_permalink(); ?>" class="eb-post--image" title="<?php the_title_attribute(); ?>">
					<?php the_post_thumbnail( 'large' ); ?>
				</a>
				<?php endif; ?>

				<figcaption class="eb-post--inner">
						<h2 class="eb-post--title"><?php the_title(); ?></h2>
...
function update($new_instance, $old_instance) {
	...
	update_option('eb_cat_post_thumb_sizes', $sizes);
	return $new_instance;
}
/**
